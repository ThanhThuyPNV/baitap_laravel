	...
	<div id="content">																				
	    <div class="row">																				
	        <div class="col-sm-9">																																							
                <div class="row">																				
                    <div class="col-sm-4">																				
                        <img width="400px"; height="400px" src="/source/image/product/{{$sanpham->image}}" alt="">																				
	                </div>																				
                    <div class="col-sm-8">																				
	 ...
	 <div class="col-sm-3">																				
	  <div class="single-item">																				
	   <div class="single-item-header">																				
	    <a href="detail/{{$sp->id}}"><img width="200px"; height="200px" src="/source/image/product/{{$sp->image}}" alt=""></a>																				
	   </div>																				
